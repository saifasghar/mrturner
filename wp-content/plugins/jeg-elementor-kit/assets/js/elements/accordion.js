!(function (e) {
  ...
  function r(t) {
    ...
    return e[t].call(d.exports, d, d.exports, r), (d.l = !0), d.exports;
  }
  (r.m = e),
    (r.c = n),
    (r.d = function (e, n, t) {
  ...
  function (e, n) {
    class r extends elementorModules.frontend.handlers.Base {
      ...
      onClick() {
        ...
        this.elements.$card_header.on("click", function (n) {
          ...
          r.hasClass("expand")
            ? (r.find(".card-expand").slideUp(), r.removeClass("expand"))
            : (e.elements.$wrapper.find(".card-expand").slideUp(),
    ...
    jQuery(window).on("elementor/frontend/init", () => {
      elementorFrontend.hooks.addAction(
        "frontend/element_ready/jkit_accordion.default",
        (e) => {
