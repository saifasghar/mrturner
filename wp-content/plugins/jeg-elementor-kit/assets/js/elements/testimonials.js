    ...
    class n extends elementorModules.frontend.handlers.Base {
      ...
      loadCarousel() {
        ...
        Object.entries(r).forEach(([e, t]) => {
          (i[t.breakpoint] = {}),
            "" !== t.items
              ? (i[t.breakpoint].items = t.items)
              : o[t.breakpoint] &&
                (i[t.breakpoint].items = o[t.breakpoint].items),
            "" !== t.margin
              ? (i[t.breakpoint].gutter = t.margin)
              : o[t.breakpoint] &&
                (i[t.breakpoint].gutter = o[t.breakpoint].gutter);
        });
        const a = {
        ...
        tns(a),
          ...
          n.show_navigation &&
            ((a.nav = !0),
            (a.navText = [
              '<i class="' + n.navigation_left + '" aria-hidden="true"></i>',
              '<i class="' + n.navigation_right + '" aria-hidden="true"></i>',
            ]));
      }
    }
    jQuery(window).on("elementor/frontend/init", () => {
      elementorFrontend.hooks.addAction(
        "frontend/element_ready/jkit_testimonials.default",
        (e) => {
